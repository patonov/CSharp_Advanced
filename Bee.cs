...
namespace Bee
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (flowers < 5)
            {
                Console.WriteLine("The bee couldn't pollinate the flowers, she needed {0} flowers more", 5 - flowers);
            }
            else
            {
                Console.WriteLine("Great job, the bee managed to pollinate {0} flowers!", flowers);
            }
