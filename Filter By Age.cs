...
namespace Filter_By_Age
{
    ...
    public class Program
    {
        ...
        public static Func<Person, bool> GetAgeFilter(string filter, int filterAge)
        {
            switch (filter)
            {
        ...
        public static Func<Person, string> GetFormatter(string format)
        {
            switch (format)
            {
        ...
        public static void PrintPeople(Person[] people, Func<Person, bool> condition, Func<Person, string> formatter)
        {
